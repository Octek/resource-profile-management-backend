...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/bookings/user/{id}": {
            "get": {
                ...
                "operationId": "Get-all-user-booking",
                "parameters": [
                    {
                        "type": "integer",
            ...
            "delete": {
                ...
                "operationId": "delete-booking-by-user-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "id",
        ...
        "/bookings/{id}": {
            "get": {
                ...
                "operationId": "get-user-booking-details-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "id",
            ...
            "delete": {
                ...
                "operationId": "delete-user-booking-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "id",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "booking",
                        "name": "UpdateUserBookingRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/bookings.UpdateUserBookingRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "bookings.UpdateUserBookingRequest": {
            "type": "object",
            "required": [
                "booking_date_time",
                "meeting_link"
