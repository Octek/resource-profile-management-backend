    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/contact_us.ContactUsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/experience/user/{id}": {
            "get": {
                ...
                "operationId": "Get-all-user-experience",
                "parameters": [
                    {
                        "type": "integer",
        ...
        "/projects": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "AddProjectRequest",
                        "name": "AddProjectsInBulk",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/projects.AddProjectsInBulk"
                        }
                    }
                ],
                "responses": {
        ...
        "/projects/get-all/{id}": {
            "get": {
                ...
                "operationId": "get-all-user-project",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "user id",
        ...
        "/projects/{id}": {
            "get": {
                ...
                "operationId": "get-user-project-details-by-user-id",
                "parameters": [
                    {
                        "type": "integer",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "name": "AddUserProjectRequest",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/projects.AddUserProjectRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "delete-user-project-by-user-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "user id",
            ...
            "patch": {
                ...
                "operationId": "update-user-project",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "project id",
        ...
        "projects.AddProjectsInBulk": {
            ...
            "properties": {
                "add_project": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/projects.AddProjectRequest"
                    }
                }
            }
        },
        "projects.AddUserProjectRequest": {
            "type": "object",
            "properties": {
                "project_id": {
                    "type": "array",
