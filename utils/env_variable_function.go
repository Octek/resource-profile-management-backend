...
const (
	...
	SomethingWentWrongWhileAddingBookingSkills         = "Something went wrong  while adding the booking skills: %v"
	SomethingWentWrongWhileAddingBookingQuestionOption = "Something went wrong  while adding the booking question option: %v"
)
